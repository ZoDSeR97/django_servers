...
class Background(models.Model):
    ...
    photo_mn = models.ImageField(upload_to='backgrounds', default='backgrounds/default.png')
    photo_mn_hover = models.ImageField(upload_to='backgrounds', default='backgrounds/default.png')
